...
def lambda_handler(event, context):
    #connect to database
    engine = db.create_engine("mysql+pymysql://admin:Dancer_1999@toothbrush-sales.cldl8ux2pqs1.us-east-1.rds.amazonaws.com/Toothbrush")
    con = engine.connect()
    ...
    AWS_BUCKET_NAME = 'xander-toothbrush-insight-project'
